...
```text
https://playwritermcp.clauxel.com/mcp
```

## Authentication

Use a bearer token from https://playwritermcp.clauxel.com/?utm_source=github_docs&utm_medium=directory&utm_campaign=sbl202605r25.
